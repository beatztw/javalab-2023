...
public class InfoController {
    ...
    public ResponseEntity<InfoDto> getInfo(@RequestParam("page") Integer page) {
        HotelsPage hotelsPage = hotelService.getAllHotels("api-key-valid",page);
        CinemasPage cinemasPage = cinemaService.getAllCinemas("api-key-valid", page);
    ...
    public ResponseEntity<InfoDto> getInfoByCity(@RequestParam("city") String city,
        ...
        HotelsPage hotelsPage = hotelService.getAllHotelsByCity(city, "api-key-valid", page);
        CinemasPage cinemasPage = cinemaService.getAllCinemasByCity(city, "api-key-valid", page);
